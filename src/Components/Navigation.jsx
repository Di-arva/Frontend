...
const Navigation = () => {
  ...
  return (
    <>
      <nav className="fixed w-full h-20 z-30 bg-lightbg flex justify-between items-center px-6 lg:px-10">
        {/* Logo */}
        <div>
          <img
            className="w-52"
        ...
        >
          <div className="bg-lightbg shadow-md  w-full py-6 px-6 flex flex-col gap-6">
